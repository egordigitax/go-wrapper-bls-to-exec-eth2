...
class Credential:
    ...
    """
    def __init__(self, *, mnemonic: str = None, mnemonic_password: str = None,
                 sign_sk: int = None, withdraw_sk: int = None,
        ...
        self.withdrawal_sk = withdraw_sk
    ...
    @staticmethod
    def make_from_pk(sign_sk, withdraw_sk, index, amount, chain_setting, hex_eth1_wd_address):
        return Credential(sign_sk=int(sign_sk, 16), withdraw_sk=int(withdraw_sk, 16), index=index, amount=amount,
                          chain_setting=chain_setting, hex_eth1_withdrawal_address=hex_eth1_wd_address)

    @property
    def signing_pk(self) -> bytes:
        return bls.SkToPk(self.sign_sk)
